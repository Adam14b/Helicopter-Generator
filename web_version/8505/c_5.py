...
st.subheader('Процессинг преимиальных сервисов')
...
def show_event(timeline_i: int, event_i: int):
    ...
    old_event_type = st.session_state.timelines[timeline_i].events[event_i].event_type
